...
func TestCreateCategory(t *testing.T) {
	...
	mock.ExpectQuery("INSERT INTO categories").
		...
		WillReturnRows(sqlmock.NewRows([]string{"id", "name", "parent_id", "created_at", "updated_at", "is_active"}).
			AddRow(categoryID, "Test Category", nil, createdAt, updatedAt, isActive))
	mock.ExpectCommit()
	...
	require.Equal(t, isActive, createdCategory.IsActive)
...
func TestGetCategoryByID(t *testing.T) {
	...
	require.Equal(t, isActive, category.IsActive)
...
func TestGetCategories(t *testing.T) {
	...
	mock.ExpectQuery("SELECT (.+) FROM categories ORDER BY name").
		WillReturnRows(sqlmock.NewRows([]string{"id", "name", "parent_id", "created_at", "updated_at", "is_active"}).
			AddRow(categoryID1, "Category 1", nil, createdAt, updatedAt, isActive).
			AddRow(categoryID2, "Category 2", nil, createdAt, updatedAt, isActive))
	...
	require.Equal(t, isActive, categories[0].IsActive)
	...
	require.Equal(t, isActive, categories[1].IsActive)
...
func TestUpdateCategory(t *testing.T) {
	...
	mock.ExpectQuery("UPDATE categories SET name = \\$2, parent_id = \\$3, updated_at = NOW\\(\\) WHERE id = \\$1 RETURNING id, name, parent_id, created_at, updated_at, is_active").
		...
		WillReturnRows(sqlmock.NewRows([]string{"id", "name", "parent_id", "created_at", "updated_at", "is_active"}).
			AddRow(categoryID, "Updated Category", nil, createdAt, updatedAt, isActive))
	mock.ExpectCommit()
	...
	require.Equal(t, isActive, updatedCategory.IsActive)
...
func TestGetCategoriesByParentID(t *testing.T) {
	...
	mock.ExpectQuery("SELECT (.+) FROM categories WHERE parent_id = \\$1 ORDER BY name").
		WithArgs(parentID).
		WillReturnRows(sqlmock.NewRows([]string{"id", "name", "parent_id", "created_at", "updated_at", "is_active"}).
			AddRow(categoryID1, "Category 1", parentID, createdAt, updatedAt, isActive).
			AddRow(categoryID2, "Category 2", parentID, createdAt, updatedAt, isActive))
